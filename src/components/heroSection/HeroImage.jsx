  ...
  return (
    <div className="relative self-end h-full w-full items-center justify-center">
      <div className=" h-full w-full">
        <div className="absolute bottom-[0px] z-10 left-[50%] -translate-x-[50%] border-5 border-cyan rounded-lg p-1">
          <img
            src={meImage}
            alt="D.Vijayapremanath"
            className="w-auto h-auto md:max-w-[570px] sm:max-w-[380px] block"
          />
        </div>
